...
TP_FN_plot =
  ...
  ungroup() %>% 
  mutate(Type = fct_relevel(Type, c("Unable to be run in ORA","FN","TP")),
...
## Fig5 
```{r}
pathway_graph = ggdraw() + draw_image(paste0("../../plots/",model_name,"/",model_name,"_pathway_graph_edited.png"))
