...
if (human.pathway.categories){
  pathway_cat_cols = read.table(aste0(input.path,"Human1_pathway_category_colours.tsv"), sep="\t", header=T, comment.char = "")
}else{
...
# ggsave(paste0("../../plots",model_name,"/test.png"), dpi=300, bg="white", width=11, height=7)
```
...
fig5 = plot_grid(plot_grid(pathway_metrics_plot,pathway_graph, nrow=2, rel_heights = c(0.35,0.65), labels = c("A","B")), 
